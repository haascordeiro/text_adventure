...
paragrafo = "Sim! "+dono.capitalize()+" era o seu dono... \n" \
            "De repente ela lembra do rosto dele e a memória ajuda a acalmar..."
input(paragrafo)
print("")

paragrafo = "Então o carro para; a gata também para, e ela vai sendo levada para um prédio alto. \n" \
            "As pessoas abrem a porta e há um homem lá dentro, um homem conhecido... \n" \
            " \n" \
...
paragrafo = "Obrigado por jogar!"
input(paragrafo)
paragrafo = "Julia Taques Cordeiro: criação do texto"
input(paragrafo)
paragrafo = "Lucas Haas Cordeiro: criação do jogo"
input(paragrafo)